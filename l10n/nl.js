OC.L10N.register(
    ...
    "A Zip archive will be created" : "Zip-archief wordt aangemaakt.",
    "The file is larger than the configured limit and it could not be compressed" : "Het bestand is groter dan de geconfigureerde limiet en kan niet worden gecomprimeerd",
    ...
    "Creating the Zip file {path} failed." : "Het maken van het Zip-bestand {pad} is mislukt.",
    "Zip files in your Nextcloud" : "Zip-bestanden in je Nextcloud",
    "Allow zipping files directly in your Nextcloud!" : "Sta direct comprimeren van bestanden in je Nextcloud toe!",
    ...
    "An error happened when trying to compress the file." : "Er is een fout opgetreden bij het comprimeren van het bestand.",
    "Only files up to {maxSize} can be compressed." : "Alleen bestanden kleiner dan {maxSize} kunnen worden gecomprimeerd."
},
