OC.L10N.register(
    ...
    "A Zip archive will be created" : "Se creará un archivo Zip",
    "The file is larger than the configured limit and it could not be compressed" : "El archivo es más grande que el límite permitido y no se pudo comprimir",
    "An error happened when trying to compress the file" : "Se produjo un error al intentar comprimir el archivo.",
    "Zipper" : "Zipper",
    ...
    "Creating the Zip file {path} failed." : "Error al crear el archivo Zip {path}.",
    "Zip files in your Nextcloud" : "Archivos Zip en su Nextcloud",
    "Allow zipping files directly in your Nextcloud!" : "¡Permite comprimir archivos directamente en su Nextcloud!",
    ...
    "Only files up to {maxSize} can be compressed." : "Solo se pueden comprimir archivos de hasta {maxSize}"
},
