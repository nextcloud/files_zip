OC.L10N.register(
    ...
    "Zip files in your Nextcloud" : "Zip failai jūsų Nextcloud'e",
    ...
    "Archive" : "Archyvuoti",
    "Select a name for the Zip archive" : "Įrašykite Zip archyvo pavadinimą",
    "_Compress {files} file_::_Compress {files} files_" : ["Suglaudinti {files} failą","Suglaudinti {files} failų","Suglaudinti {files} failų","Suglaudinti {files} failų"],
    "The name selected is invalid." : "Neteisingas pasirinktas vardas.",
