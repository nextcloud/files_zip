OC.L10N.register(
    ...
    "A Zip archive will be created" : "Bir zip arşivi oluşturulacak",
    "The file is larger than the configured limit and it could not be compressed" : "Dosya yapılandırılmış sınır değerinden büyük ve sıkıştırılamadı",
    "An error happened when trying to compress the file" : "Dosya sıkıştırılırken bir sorun çıktı",
    "Zipper" : "Sıkıştırıcı",
    ...
    "Creating the Zip file {path} failed." : "{path} Zip dosyası oluşturulamadı.",
    "Zip files in your Nextcloud" : "Nextcloud kopyanızdaki Zip dosyaları",
    "Allow zipping files directly in your Nextcloud!" : "Dosyalarınızı doğrudan Nextcloud üzerinde sıkıştırmanızı sağlar!",
    ...
    "Only files up to {maxSize} can be compressed." : "Yalnızca {maxSize} boyutuna kadar olan dosyalar sıkıştırılabilir."
},
