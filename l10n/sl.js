OC.L10N.register(
    ...
    "Creating the Zip file {path} failed." : "Ustvarjanje arhiva na mestu {path} je spodletelo.",
    ...
    "Archive" : "Arhiv",
    "Select a name for the Zip archive" : "Izbor imena arhiva zip",
    "_Compress {files} file_::_Compress {files} files_" : ["Stisni {files} datoteko","Stisni {files} datoteki","Stisni {files} datoteke","Stisni {files} datotek"],
    "The name selected is invalid." : "Izbrano ime ni veljavno.",
